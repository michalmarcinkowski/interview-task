 ...
 *
 * This class is responsible for orchestrating the invoice sending workflow,
 * following a fail-fast approach and ensuring data consistency even when external services fail.
 *
 ...
 * - If notification fails, we can retry without losing the status change
 ...
 *
 * @see SendInvoiceCommand
 */
class SendInvoiceHandler implements SendInvoiceHandlerInterface
{
     ...
     *
     * @param  \Modules\Invoices\Domain\Models\Invoice  $invoice  The invoice to generate message for
     * @return string The email message
     */
    private function generateInvoiceEmailMessage($invoice): string
    {
